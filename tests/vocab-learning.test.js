...
['vocab-view-learn', 'vocab-view-challenge', 'vocab-view-translation', 'vocab-view-errata', 'vocab-view-lists', 'vocab-view-stats', 'learning-mode-select', 'known-words-list', 'review-words-list', 'word-ai-definition'].forEach(id => assert(index.includes(`id="${id}"`), `背词 UI 缺少 ${id}`));
